...
public class GpsStatusDetector {
    ...
    private WeakReference<net.alexandroid.gps.GpsStatusDetector.GpsStatusDetectorCallBack> mCallBackWeakReference;

    public GpsStatusDetector(Activity activity) {
        this.mActivityWeakReference = new WeakReference<>(activity);
        this.mCallBackWeakReference = new WeakReference<>((net.alexandroid.gps.GpsStatusDetector.GpsStatusDetectorCallBack) activity);
    }

    public GpsStatusDetector(Fragment fragment) {
        this.mActivityWeakReference = new WeakReference<>((Activity) fragment.getActivity());
        this.mCallBackWeakReference = new WeakReference<>((net.alexandroid.gps.GpsStatusDetector.GpsStatusDetectorCallBack) fragment);
    }

    public void checkGpsStatus() {
        Activity activity = mActivityWeakReference.get();
        net.alexandroid.gps.GpsStatusDetector.GpsStatusDetectorCallBack callBack = mCallBackWeakReference.get();
    ...
    private void setLocationRequest(final Activity activity, final net.alexandroid.gps.GpsStatusDetector.GpsStatusDetectorCallBack callBack) {
